                ...
                <div class="row ">
                  ...
                  <div class="col-md-6 col-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="retentions" class="form-control" name="retention" required readonly>
                      <input type="text" id="retention" class="form-control" name="expiration_date" hidden>
                    ...
                    <div class="form-group">
                      ...
                      <select type="text" id="number_container" class="form-control select2" style="width: 100%"
                        ...
                        @foreach ($numberContainers as $numberContainer)
                          <option value="{{ $numberContainer->number_container }}"
                            ...
                            data-value4="{{ $numberContainer->description }}"
                            {{ $numberContainer->number_container == str_pad(DB::table('archive_containers')->latest()->first()->number_container, 3, '0', STR_PAD_LEFT) ? 'selected' : '' }}>
                  ...
                  <div class="col-md-4 col-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="number_app" name="number_app" class="form-control">
