        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <form id="myForm" class="form" method="POST" action="{{ route('retention.update', $retentions->id) }}"
                  ...
                  <div class="col-md-6 col-6 mx-auto">
                    ...
                    <div class="form-group" hidden>
                      ...
                      <input type="text" id="code" class="form-control" placeholder="Kode" name="code"
                        value="{{ old('code', $retentions->code) }}" required readonly>
                      @if ($errors->has('code'))
                        <p style="font-style: bold; color: red;">
                          {{ $errors->first('code') }}</p>
                      @endif
                    ...
                    <div class="form-group">
                      ...
                      <select id="document_type" class="form-control choices" name="document_type" required>
                        <option value="" disabled selected>Choose</option>
                        <option value="MUSNAH" {{ $retentions->document_type == 'MUSNAH' ? 'selected' : '' }}>Musnah
                        </option>
                        <option value="PERMANEN"{{ $retentions->document_type == 'PERMANEN' ? 'selected' : '' }}>Permanen
                        </option>
                      </select>
