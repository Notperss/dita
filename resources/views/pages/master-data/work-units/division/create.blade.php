        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <form class="form" method="POST" action="{{ route('division.store') }}" enctype="multipart/form-data"
                id=myForm>
                @csrf
                <div class="row ">
                  ...
                  <div class="col-12 d-flex justify-content-end">
                    ...
                    <a href="{{ route('division.index') }}" class="btn btn-light-secondary me-1 mb-1">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
