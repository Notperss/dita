        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <form id="myForm" class="form" method="POST" action="{{ route('type_user.update', $type_users->id) }}"
                ...
                <div class="row ">
                  <div class="col-md-8 col-12 mx-auto">
                    <div class="form-group">
                      ...
                      <input type="text" id="name" class="form-control" name="name"
                        value="{{ old('name', $type_users->name) }}" required>
                      @if ($errors->has('name'))
                  ...
                  <div class="col-12 d-flex justify-content-end">
                    ...
                    <a href="{{ route('type_user.index') }}" class="btn btn-light-secondary me-1 mb-1">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
