              ...
              <div class="card-body px-4 py-4-5">
                <div class="row">
                  ...
                  <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                    <h5 class="text-muted font-semibold">Total Arsip</h5>
                    <h5 class="font-extrabold mb-0">{{ DB::table('archive_containers')->count() }}</h5>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <table class="table table-hover table-lg">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="col-auto">
                          <p class=" mb-0">I love your design! It’s so beautiful and unique! How did you learn to
                            do this?</p>
                        </td>
                      </tr>
                    </tbody>
