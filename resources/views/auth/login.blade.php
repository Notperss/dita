...
@section('content')
  <div class="row h-100">
    <div class="col-lg-5 col-12">
      <div id="auth-left">
        <div class="auth-logo">
          {{-- <a href="{{ route('backsite.dashboard.index') }}"><img
              ...
              alt="Logo"></a> --}}
          {{-- <a href="{{ route('backsite.dashboard.index') }}"><img src="{{ asset('dist/assets/img/CMNPFIX.png') }}"
              alt="Logo"> --}}
          </a>
        </div>
        <div class="text-center">
          ...
          <h1 class="auth-title ">Data Input Arsip</h1>
          <p class="auth-subtitle  my-5">Harap Login terlebih dahulu.</p>
        </div>
